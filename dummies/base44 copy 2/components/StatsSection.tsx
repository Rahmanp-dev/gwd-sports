  ...
  return (
    <section className="relative py-32 px-4 sm:px-6 lg:px-8 bg-white overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-br from-purple-100 to-purple-50 rounded-full blur-3xl opacity-60"
      />
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="relative bg-gradient-to-br from-white to-purple-50 rounded-3xl p-10 shadow-2xl hover:shadow-[0_30px_80px_rgba(147,51,234,0.4)] transition-all duration-500 border-4 border-purple-100 hover:border-purple-300 overflow-hidden">
                {/* Icon */}
                <motion.div
                  whileHover={{ scale: 1.3, rotate: 360 }}
                  transition={{ duration: 0.6 }}
                  className={`w-20 h-20 bg-gradient-to-br ${stat.color} rounded-2xl flex items-center justify-center mb-8 shadow-xl group-hover:shadow-2xl group-hover:shadow-purple-500/50 transition-all duration-500`}
                >
                  <stat.icon className="w-10 h-10 text-white" />
                </motion.div>

                {/* Number */}
                <div className={`text-transparent bg-clip-text bg-gradient-to-br ${stat.color} mb-4 drop-shadow-[0_0_20px_rgba(147,51,234,0.3)]`}>
                  <AnimatedCounter value={stat.value} suffix={stat.suffix} />
                </div>

                {/* Label */}
                <div className="text-gray-700 font-black text-xl uppercase tracking-wider" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '0.1em' }}>
                  {stat.label}
                </div>
        ...
        >
          <div className="inline-flex items-center gap-4 px-10 py-6 bg-gradient-to-r from-purple-600 to-purple-400 text-white rounded-full shadow-2xl shadow-purple-600/50">
