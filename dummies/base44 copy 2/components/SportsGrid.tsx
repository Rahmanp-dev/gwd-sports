  ...
  return (
    <section className="relative py-32 px-4 sm:px-6 lg:px-8 bg-white overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-1/4 right-0 w-[600px] h-[600px] bg-purple-100/30 rounded-full blur-3xl"
      />
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-6xl sm:text-7xl lg:text-8xl font-black text-gray-900 mb-6 uppercase tracking-tighter leading-none" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
            Choose Your
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-purple-500 to-purple-600">
              Champion Path
            </span>
          </h2>
          <motion.div
            ...
            className="w-32 h-2 bg-gradient-to-r from-purple-600 to-purple-400 mx-auto mb-8 shadow-lg shadow-purple-600/50"
          />
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto font-bold">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {sports.map((sport, index) => (
            ...
            >
              <div className="relative overflow-hidden bg-white rounded-3xl shadow-2xl hover:shadow-[0_20px_60px_rgba(147,51,234,0.3)] transition-all duration-500 transform-gpu">
                {/* Image */}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black to-transparent">
                  ...
                  <div className="text-purple-300 font-bold uppercase tracking-wider text-sm">
                    {sport.tagline}
                  </div>
                </div>
          ...
          >
            <div className="h-80 bg-gradient-to-br from-purple-600 via-purple-500 to-purple-400 rounded-3xl flex items-center justify-center shadow-2xl hover:shadow-[0_20px_60px_rgba(147,51,234,0.6)] transition-all duration-500 overflow-hidden">
              <div className="text-center z-10 relative p-8">
                ...
                <h3 className="text-5xl font-black text-white uppercase mb-4 tracking-tight" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                  Not Sure?
                </h3>
                <p className="text-white text-xl mb-6 font-bold">
                  Get expert guidance
                </p>
                <div className="inline-flex items-center gap-3 text-white font-black uppercase text-base border-4 border-white px-8 py-4 hover:bg-white hover:text-purple-600 transition-all rounded-full">
