...
export const SPORTS: Sport[] = [
  {
    ...
    name: 'Football',
    icon: '⚽',
    description: 'Master the beautiful game with world-class coaching and state-of-the-art facilities.',
  ...
  },
  {
    ...
    name: 'Basketball',
    icon: '🏀',
    description: 'Elevate your game with professional training in shooting, dribbling, and court strategy.',
  ...
  },
  {
    ...
    name: 'Tennis',
    icon: '🎾',
    description: 'Perfect your serve and backhand with expert coaches on premium courts.',
  ...
  },
  {
    ...
    name: 'Table Tennis',
    icon: '🏓',
    description: 'Develop lightning-fast reflexes and precision with our table tennis program.',
  ...
  },
  {
    ...
    name: 'Swimming',
    icon: '🏊',
    description: 'Learn all strokes and techniques in our Olympic-sized, temperature-controlled pool.',
  ...
  },
  {
    ...
    name: 'Badminton',
    icon: '🏸',
    description: 'Master footwork, smashes, and court coverage with professional guidance.',
  ...
  },
  {
    ...
    name: 'Cricket',
    icon: '🏏',
    description: 'Train in batting, bowling, and fielding with experienced coaches and modern equipment.',
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    rating: 5,
    content: 'Master Grade transformed my game completely. The coaches are world-class and the facilities are exceptional. I went from a beginner to competing at state level in just 2 years!',
  ...
  },
  {
    ...
    rating: 5,
    content: 'The structured training program and personalized attention helped me improve my skills dramatically. The team here genuinely cares about each student\'s progress.',
  ...
  },
  {
    ...
    rating: 5,
    content: 'My daughter has gained so much confidence since joining Master Grade. The coaches are patient, professional, and create a safe learning environment.',
  },
  {
    id: '4',
    name: 'David Kumar',
    ...
    rating: 5,
    content: 'Best sports academy I\'ve trained at. The tactical training and fitness programs are top-notch. I secured a college scholarship thanks to Master Grade!',
  ...
  },
  {
    ...
    rating: 5,
    content: 'The training methodology is fantastic. I\'ve learned techniques I never knew existed. The community here is supportive and motivating.',
  ...
  },
  {
    ...
    rating: 5,
    content: 'Master Grade provided me with the platform to excel. The modern equipment and expert coaching have been instrumental in my development.',
  },
];
...
export const EVENTS: Event[] = [
  {
    ...
    description: 'Annual football championship featuring top academies from across the region. Open to all age groups.',
    registrationUrl: '#',
    isFeatured: true,
  },
  {
    ...
    description: 'Learn from professional players and coaches. Limited seats available.',
    registrationUrl: '#',
    isFeatured: true,
  },
  {
...
export const FEATURES: Feature[] = [
  {
    ...
    description: 'State-of-the-art equipment and infrastructure designed for optimal training.',
    icon: '🏟️',
  },
  {
    id: '2',
  ...
  },
  {
    ...
    description: 'Regular assessments and progress reports to monitor improvement.',
    icon: '📈',
  },
  {
    id: '6',
    title: 'Safe Environment',
    description: 'CCTV surveillance, trained staff, and comprehensive safety protocols.',
    icon: '🛡️',
  },
];