...
export const MGRL_HERO_DATA = {
  ...
  description: "Experience the thrill of competitive racing. Professional training, championship events, and a community of speed enthusiasts pushing limits every day.",
  icon: "🏁",
  backgroundImage: "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=1920&h=1080&fit=crop",
  stats: [
...
export const MGRL_EVENTS: Event[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1566134101742-88e5c247a1c3?w=1200&h=800&fit=crop",
...
export const MGRL_FEATURES: Feature[] = [
  {
    ...
    description: "Learn from professional racers and certified instructors with championship-winning experience",
    gradient: "from-amber-500 to-yellow-500",
  },
  {
    icon: Gauge,
    title: "Performance Analysis",
    description: "Advanced telemetry systems and data analytics to optimize your racing performance",
    gradient: "from-orange-500 to-amber-500",
  },
  {
    icon: Flag,
    title: "Race Strategy",
    description: "Master racing lines, overtaking techniques, and strategic decision-making",
    gradient: "from-yellow-500 to-amber-500",
  },
  {
    icon: Zap,
    title: "Speed Development",
    description: "Progressive training programs to enhance reflexes, reaction time, and racing skills",
    gradient: "from-red-500 to-orange-500",
  },
  {
    icon: Shield,
    title: "Safety First",
    description: "Comprehensive safety training, modern equipment, and certified racing circuits",
    gradient: "from-amber-600 to-yellow-600",
  },
  {
    icon: Users,
    title: "Racing Community",
    description: "Join a passionate community of racers, attend events, and build lasting connections",
...
export const MGRL_PROGRAMS = [
  ...
  },
  {
    ...
    age: "18+ years",
    description: "Championship-level training and professional racing opportunities",
