...
export const GALAXY_EVENTS_HERO_DATA = {
  ...
  description: "Experience the ultimate convergence of sports, culture, and excellence. From championship tournaments to star-studded galas, Galaxy Events brings together the best of Master Grade in spectacular fashion.",
  icon: "🌟",
  backgroundImage: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=1920&h=1080&fit=crop",
  stats: [
...
export const GALAXY_MAJOR_EVENTS: Event[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1505236858219-8359eb29e329?w=1200&h=800&fit=crop",
...
export const GALAXY_EVENT_CATEGORIES = [
  {
    ...
    icon: "🏆",
    description: "Premier tournaments across football, basketball, racing and more",
    gradient: "from-purple-500 to-indigo-500",
  },
  {
    title: "Awards & Galas",
    icon: "⭐",
    description: "Star-studded ceremonies celebrating excellence and achievement",
    gradient: "from-violet-500 to-purple-500",
  },
  {
    title: "Community Gatherings",
    icon: "🎪",
    description: "Fun-filled family events, carnivals, and community celebrations",
    gradient: "from-fuchsia-500 to-pink-500",
  },
  {
    title: "Workshops & Summits",
    icon: "🎓",
    description: "Educational conferences, skill development workshops, and seminars",
...
export const GALAXY_FEATURES: Feature[] = [
  {
    ...
    description: "Continuous stream of exciting events throughout the year for all ages",
    gradient: "from-purple-500 to-indigo-500",
  },
  {
    icon: Trophy,
    title: "Championship Hosting",
    description: "World-class facilities and organization for major sporting tournaments",
    gradient: "from-violet-500 to-purple-500",
  },
  {
    icon: Users,
    title: "Community Focused",
    description: "Events designed to bring together athletes, families, and supporters",
    gradient: "from-fuchsia-500 to-pink-500",
  },
  {
    icon: Sparkles,
