          ...
          <TabsContent value="stats" className="space-y-6">
            ...
            >
                ...
                <Card className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700/50">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div>
                      ...
                      <Progress value={studentData.stats.attendance} className="h-2" />
                    </div>
                    <div>
                      <div className="flex justify-between mb-2">
              ...
              <motion.div variants={itemVariants}>
                <Card className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700/50">
                  <CardHeader>
                    <CardTitle className="text-white">Season Highlights</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-3 bg-blue-500/10 rounded-lg border border-blue-500/20">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-white font-semibold">Clean Sheets</p>
                          <p className="text-sm text-gray-400">Defensive Record</p>
                        </div>
                      </div>
              ...
              <Card className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700/50">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[...studentData.upcomingMatches, ...studentData.recentMatches].map(
                      (item, index) => (
                        <div
                          key={index}
                          className="p-4 bg-gray-800/50 rounded-lg border border-gray-700 hover:border-green-500/50 transition-all"
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-white font-semibold">{studentData.class}</p>
                      </div>
                      <div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-sm">
                            Please submit your medical fitness certificate before the
                            next match. Contact the sports coordinator for more details.
                          </p>
                        </div>
                      </div>
                    </div>
