      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-6xl sm:text-7xl lg:text-8xl font-black text-white mb-6 uppercase tracking-tighter leading-none" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
            The Elite
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-500 to-amber-400">
              Difference
            </span>
          </h2>
          <motion.div
          ...
          {reasons.map((reason, index) => (
            ...
            >
              <div className="relative bg-gray-900/50 backdrop-blur-md border border-amber-500/20 rounded-3xl p-8 h-full shadow-2xl hover:shadow-[0_20px_60px_rgba(251,191,36,0.4)] transition-all duration-500 overflow-hidden">
                ...
                {/* Floating Number */}
                <div className="absolute top-4 right-4 text-8xl font-black text-amber-500/5 group-hover:text-amber-500/10 transition-colors" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                  {index + 1}
                </div>
