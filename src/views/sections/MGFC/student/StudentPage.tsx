            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="text-sm md:text-base text-gray-100/90 font-medium flex flex-wrap items-center gap-x-4 gap-y-1">
                  ...
                  <span className="text-white/40 hidden sm:inline select-none">
                    •
                  </span>
                  <span>
                    <strong className="text-white font-bold">Academy:</strong>{" "}
                    {academyName}
                  </span>
                  <span className="text-white/40 hidden sm:inline select-none">
                    •
                  ...
                  <span>
                    <strong className="text-white font-bold">Level:</strong>{" "}
                  ...
                  <span>
                    <strong className="text-white font-bold">Sports:</strong>{" "}
                ...
                <Card className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700/50 h-full">
                  ...
                  <CardContent className="space-y-4">
                    {upcomingMatches.map((match) => (
                      <div
                        key={match.id}
                        className="flex justify-between items-center p-3 bg-gray-800/80 rounded-lg border border-gray-700/50 hover:bg-gray-700 transition-colors"
                      >
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <Badge
                              variant="outline"
                              className="text-[10px] bg-gray-900 text-gray-300 border-gray-600"
                            >
                              {match.type}
                            </Badge>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2 pt-2">
                      ...
                      <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-xl text-center">
                        <span className="text-xs text-green-500 font-bold block mb-0.5">
                          Present
                        </span>
              ...
              <motion.div variants={itemVariants} className="lg:col-span-2">
                <Card className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700/50 h-full">
                  <CardHeader className="flex flex-row items-center justify-between pb-3">
                    ...
                    <Badge
                      variant="outline"
                      className="text-gray-400 border-gray-700 text-xs font-semibold"
                    >
                      Chronological Order
                    </Badge>
                  </CardHeader>
                        ...
                        {studentProfile?.sports?.map(
                          (sport: string, idx: number) => (
                            <Badge
                              key={idx}
                              variant="secondary"
                              className="bg-gray-800 text-gray-300 border-transparent capitalize text-xs"
                            >
                              {sport}
                            </Badge>
                          ),
